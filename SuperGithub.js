// ==UserScript==
// @icon          https://raw.githubusercontent.com/SQ8888/SuperGithub/main/favicon.ico
// @name          Github 镜像加速访问、克隆和下载
// @namespace     Super.Github
// @author        SQ8888
// @homepageURL   https://github.com/SQ8888/SuperGithub
// @supportURL    https://github.com/RC1844/SuperGithub/issues
// @license       MIT License
// @description   镜像访问GitHub,极速Clone、Release/Raw/Zip加速
// @include       *://github.com/*
// @include       *://github*
...
(function () {
    ...
    MirrorUrl[0] = ["https://hub.sqyun.tk/", "SQcould", "殇情"];
    MirrorUrl[1] = ["https://hub.njuu.cf/", "网上的接口", "网上的接口"];
    MirrorUrl[2] = ["https://cors.zme.ink/https://github.com", "netnr", "由@netnr提供"]
    //添加对应索引即可使用
    var CloneSet = [1, 2, 0];
    var MirrorSet = [1, 2, 0];
    var DownloadSet = [1, 2, 0];
    var RawSet = [1, 2, 0];
  
    //其他
    var OtherUrl = new Array();
    OtherUrl = [
      ["https://hub.nuaa.cf/", "网上的可用接口"],
      ["https://hub.yzuu.cf/", "网上的可用接口"],
